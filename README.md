...
### Вопрос 1. Загрузите файл Lab01-03.exe на сайт www.VirusTotal.com. Соответствует ли он какой-то из 
### имеющихся антивирусных сигнатур? 

![Screenshot_1](https://github.com/user-attachments/assets/9190e1ce-b709-45fc-b2df-df3934eb3448)

### Вопрос 2. Есть ли какие-либо признаки того, что файл упакован или обфусцирован? Если да, то что это за 
### признаки? Если файл упакован, попробуйте его распаковать. 

![Screenshot_2](https://github.com/user-attachments/assets/07bf3784-1a2d-4750-8548-be435c92f819)
![Screenshot_3](https://github.com/user-attachments/assets/eea9fd40-46cf-4fce-837d-83bb872b04b1)
...
### Вопрос 4. С помощью каких локальных или сетевых признаков можно было бы идентифицировать данное 
### вредоносное ПО на зараженных компьютерах?
